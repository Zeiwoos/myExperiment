...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='Prepare MVTec dataset for adapter')
    parser.add_argument('--root', type=str, required=True, help='Path to MVTec dataset root directory')
