...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='Prepare VisA dataset for adapter')
    parser.add_argument('--root', type=str, required=True, help='Path to VisA dataset root directory')
