...
# 训练自定义数据集的脚本
# 使用方法: bash scripts/train_custom_dataset.sh
...
# 训练配置
dataset_name=hxzy_v4_train_1shot_nosongdong_half_plus
epochs=15
learning_rate=0.001
batch_size=8
image_size=518
...
checkpoint_path="adapter_checkpoints/train_on_hxzy_v4_train_1shot_nosongdong_half_3adapters_batch8_v2/epoch_15.pth"  # 示例: adapter_checkpoints/train_on_mvtec_3adapters_batch8/epoch_15.pth
