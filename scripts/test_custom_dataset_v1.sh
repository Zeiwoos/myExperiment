...
# 测试自定义数据集的脚本
# 使用方法: bash scripts/test_custom_dataset_v1.sh
...
base_dir=train_on_${train_dataset}_test_on_${test_dataset}_3adapters_batch8_v1
