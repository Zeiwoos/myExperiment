...
# 使用 test_custom_dataset_v4.py 对自定义数据集进行测试（包含 A/B/C 及困难项统计）
# 使用方法: bash scripts/test_custom_dataset_v4.sh
...
model_map[hxzy_v4_train_4shot_nongsongdong_half]=adapter_checkpoints/train_on_hxzy_v4_train_4shot_nongsongdong_half_3adapters_batch8_v2/epoch_15.pth
...
# 测试配置
train_dataset=hxzy_v4_train_4shot_nongsongdong_half  # 训练模型使用的数据集
